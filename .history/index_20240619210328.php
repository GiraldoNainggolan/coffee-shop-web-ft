...
<body>
    ...
    <header class="header">
        ...
        <nav class="navbar navbar-expand-lg">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a href="#about" class="text-decoration-none">Tentang</a>
                </li>
                <li class="nav-item">
                    <a href="#menu" class="text-decoration-none">Menu</a>
                </li>
                <li class="nav-item">
                    <a href="#gallery" class="text-decoration-none">Galeri</a>
                </li>
                <li class="nav-item">
                    <a href="#blogs" class="text-decoration-none">Blogs</a>
                </li>
                <li class="nav-item">
                    <a href="#contact" class="text-decoration-none">Hubungi</a>
                </li>
                <li class="nav-item">
                    <a href="users/login.php" class="text-decoration-none">Akun</a>
                </li>
            </ul>
            </div>
        </nav>
    ...
    <section class="home" id="home">
        <div class="content">
            <h3>MARI BERKUNJUNG DI KEDAI KOPI RUMAH SEDUH</h3>
            <p>
    ...
    <section class="about" id="about">
        ...
        <div class="row g-0">
            ...
            <div class="content">
                <h3>Selamat Datang Rumah Seduh!</h3>
                <p>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="box">
                            ...
                            <div class="content">
                                ...
                                <span>Oleh Tim Barista Profesional</span>
                    ...
                    <div class="col-md-4">
                        <div class="box">
                            ...
                            <div class="content">
                                <a href="https://www.taylorsofharrogate.co.uk/news/carbon-neutral-tea-and-coffee" target="_blank" class="title text-decoration-none">Kopi Hasil Kebun Sendiri Di Rumah Seduh Adalah Pilihan Konsumsi Terbaik di Indonesa</a>
                                <span>Oleh Tim Budidaya Lapangan</span>
                                <p>Ini adalah budaya dari nenek moyang kami membesarkan kopi sendiri mengolahan kopi dengan teknik yang kami buat dengan memperhatikan juga segala bentuk aspek pada lingkungannya sendiri sehingga wajib semua orang mencoba merasakannya . . .</p>
                                <center>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="box">
                            ...
                            <p>
                            Tentu, berikut adalah testimoni kopi lain yang terdiri dari 123 karakter huruf:
"Kopi adalah teman setia saat belajar dan bekerja. Aroma dan rasanya menghidupkan hari, menjadikannya lebih produktif dan menyenangkan."
                            </p>
                            <img src="assets/images/alfian.jpg" alt="" class="user">
                            <h3>Alfian</h3>
                            <div class="stars">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                    ...
                    <div class="col-md-4">
                        <div class="box">
                            <img src="assets/images/quote-img.png" alt="" class="quote">
                            <p>
                            Kopi memberikan semangat dan inspirasi dalam setiap tegukan. Tanpanya, hari-hari akan terasa kurang bermakna dan membosankan.
                            </p>
                            <img src="assets/images/erpan.jpg" alt="" class="user">
                            <h3>Erpan</h3>
                            <div class="stars">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                    ...
                    <div class="col-md-4">
                        <div class="box">
                            <img src="assets/images/quote-img.png" alt="" class="quote">
                            <p>
                                saya adalah mahasiswa pecinta kopi karna tanpa kopi hidup
                                sangat tidak bermakna bahkan akan terasa hampa tanpanya.
                            </p>
                            <img src="assets/images/giraldo.jpg" alt="" class="user">
                            <h3>Giraldo</h3>
                            <div class="stars">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
    ...
    <section class="footer">
        <div class="footer-container">
            ...
            <div class="newsletters">
                <h2>Kabar Terbaru</h2>
                <br />
                <p>Mari Berlangganan Untuk Komunitas ini!</p>
                <div class="input-wrapper">
                    <input type="email" class="newsletter" placeholder="Alamat Email Anda">
    ...
    <div class="chat-bar-collapsible">
        <button id="chat-button" type="button" class="collapsible">Kirim Pesan Mu! &nbsp;
